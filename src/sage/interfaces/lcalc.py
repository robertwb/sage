...
class LCalc(SageObject):
    ...
    def zeros(self, n, L=''):
        ...
        EXAMPLES:
            ...
            [14.134725139, 21.022039637, 25.010857575, 30.424876124]
            sage: lcalc.zeros(5, L='--tau')                # long
            [9.2223793976, 13.907549858, 17.442776978, 19.656513140, 22.336103633]
    ...
    def zeros_in_interval(self, x, y, stepsize, L=''):
        ...
        EXAMPLES:
            ...
            [(14.134725139, 0.18467291561), (21.022039637, -0.067789328954), (25.010857575, -0.055587278126)]
        """
        L = self._compute_L(L)
        RR = sage.rings.all.RealField(prec)
    ...
    def value(self, s, L=''):
        ...
        the PARI C library):
            sage: (0.5 + 100*I).zeta()
            2.6926198856813239 - 0.020386029602598159*I
        """
        L = self._compute_L(L)
    ...
    def values_along_line(self, s0, s1, number_samples, L=''):
        ...
        EXAMPLES:
            ...
            [(0.50000000000, -1.4603545084),
             (0.50000000000 + 4.0000000000*I, 0.60678376444 + 0.091112139955*I),
             (0.50000000000 + 8.0000000000*I, 1.2416151054 + 0.36004758836*I),
             (0.50000000000 + 12.000000000*I, 1.0159366503 - 0.74511247221*I),
             (0.50000000000 + 16.000000000*I, 0.93854540843 + 1.2165878159*I)]
        """
        L = self._compute_L(L)
        CC = sage.rings.all.ComplexField(prec)
        s0 = CC(s0)
    ...
    def twist_zeros(self, n, dmin, dmax, L=''):
        ...
        EXAMPLES:
            ...
            {-3: [8.0397371538, 11.249206208, 15.704619177],
              5: [6.6484533437, 9.8314444311, 11.958845623]}
        """
        L = self._compute_L(L)
        RR = sage.rings.all.RealField(prec)
        Z = sage.rings.all.Integer
